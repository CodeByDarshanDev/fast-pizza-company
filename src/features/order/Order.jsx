...
function Order() {
  ...
  return (
    <div className="space-y-8 px-4 py-6 ">
      ...
      <ul className="dive-stonr-200 divide-y border-b border-t">
        {cart.map((item) => (
          <OrderItem
            item={item}
            key={item.pizzaId}
      ...
      <div className="space-y-2 bg-stone-200 px-6 py-5">
        <p className="font-med text-sm font-medium text-stone-600">
          Price pizza: {formatCurrency(orderPrice)}
        </p>
        {priority && (
          <p lassName="font-med text-sm font-medium text-stone-600">
